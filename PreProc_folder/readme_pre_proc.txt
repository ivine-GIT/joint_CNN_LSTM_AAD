...
Make two new empty folders and rename them as 'EEG' and 'Speech_data'. 

Then run the jupyter notebook Data_processing.ipynb. This script will generate the following files and data.
